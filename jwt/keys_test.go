...
var (
	keysHMAC  = []byte(strings.Repeat("a", 64))
	keysRSA   = []*rsa.PrivateKey{testKeyRSA1024, testKeyRSA2048, testKeyRSA4096}
	keysECDSA = []*ecdsa.PrivateKey{testKeyEC256, testKeyEC384, testKeyEC521}
)
